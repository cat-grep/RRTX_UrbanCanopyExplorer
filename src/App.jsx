    ...
    return (
        <div className="app">
            <header className="banner">
                ...
                <h1 className="brand">
                    <span className="title-full">Round Rock Urban Canopy Explorer</span>
                    <span className="title-short" aria-hidden="true">Urban Canopy Explorer</span>
                </h1>

                <a className="btn-gh" href="https://github.com/cat-grep/RRTX_UrbanCanopyExplorer/" target="_blank" rel="noopener noreferrer" >
